package umn.ac.id.week07_30360;
...
public class MainActivity extends AppCompatActivity {
    ...
    static final int REQUEST_IMAGE_CAPURE = 1;
    static final int REQUEST_VIDEO_CAPURE = 2;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        }else if (requestCode == REQUEST_VIDEO_CAPURE && resultCode == RESULT_OK) {
        ...
        foto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(takePictureIntent.resolveActivity(getPackageManager()) != null){
                    startActivityForResult(takePictureIntent, REQUEST_IMAGE_CAPURE);
                }
            }
        });
        ...
        video.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(takeVideoIntent.resolveActivity(getPackageManager()) != null){
                    startActivityForResult(takeVideoIntent, REQUEST_VIDEO_CAPURE);
                }
            }
        });
    }
